...
\restrict gMjVEfgxZx0jUgiFv1iD6224j2jk0Xn58AY2rDda517UtGpjvi26NQhnzgAtWkI
...
--
-- Data for Name: consolidated_reports; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: conversation_contexts; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: kpi_snapshots; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: memories; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: panel_reports; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: provider_configs; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: review_events; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: review_metrics; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: summary_notes; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: user_facts; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.user_facts (id, user_id, kind, fact_type, value_json, confidence, updated_at, normalized_value, source_message_id, pending_review, latest, sensitivity) FROM stdin;
\.


--
-- Data for Name: user_profiles; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.user_profiles (user_id, role, name, preferences, conversation_style, interests, created_at, updated_at, auto_fact_extraction_enabled) FROM stdin;
\.


--
-- Name: audit_logs_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: consolidated_reports_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: kpi_snapshots_snapshot_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: panel_reports_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: review_events_event_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
\unrestrict gMjVEfgxZx0jUgiFv1iD6224j2jk0Xn58AY2rDda517UtGpjvi26NQhnzgAtWkI
