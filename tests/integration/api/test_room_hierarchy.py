...
class TestRoomHierarchy:
    ...
    def test_create_main_room_fails_if_already_exists(self, mock_db, authenticated_client):
        ...
        mock_db.execute_query.return_value = [{'type': 'main', 'room_id': 'r1', 'name': 'n', 'owner_id': USER_ID, 'created_at': 1, 'updated_at': 1, 'message_count': 0}]
    ...
    def test_create_sub_room_success(self, mock_db, authenticated_client):
        ...
        mock_db.execute_query.return_value = [main_room_data]
    ...
    def test_delete_room_logic(self, mock_db, authenticated_client):
        """Test deleting a room."""
        mock_db.execute_query.return_value = [{"room_id": "sub-to-delete", "owner_id": USER_ID, "type": "sub", "name": "n", "created_at": 1, "updated_at": 1}]
        mock_db.execute_update.return_value = 1

        response = authenticated_client.delete("/api/rooms/sub-to-delete")
