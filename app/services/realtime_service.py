...
from app.core.realtime import ConnectionManager, connection_manager
...
class RealtimeService:
    ...
    def __init__(self, manager: Optional[ConnectionManager] = None) -> None:  # pragma: no cover - simple wiring
