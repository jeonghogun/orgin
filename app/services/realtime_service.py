...
# from app.api.routes.websockets import manager as connection_manager  # Moved to avoid circular import
...
class RealtimeService:
    ...
    def __init__(self, manager=None) -> None:  # pragma: no cover - simple wiring
